package com.techstore.api.security.config;

// Manejador centralizado para respuestas 401/403 en formato JSON.
import com.techstore.api.security.exception.SecurityExceptionHandler;
// Filtro que valida el JWT en cada request y establece la autenticación en el contexto.
import com.techstore.api.security.filter.JwtAuthenticationFilter;
// Propiedades externas de seguridad (secret, issuer, TTLs, CORS, etc.).
import com.techstore.api.security.jwt.JwtProperties;
...
import com.techstore.api.security.repository.UserAccountRepository;
...
public class SecurityConfig {
    ...
    // Expone el AuthenticationManager que construye Spring a partir de la
    // configuración.
    @Bean
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/products/**").hasAnyAuthority("ROLE_USER","USER")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/products/**").hasAnyAuthority("ROLE_USER","USER")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/products/**").hasAnyAuthority("ROLE_USER","USER")
     ...
     * - allowedOrigins: toma la lista desde propiedades
